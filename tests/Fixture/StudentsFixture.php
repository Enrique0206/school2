...
class StudentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'boss_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_students_bosses1_idx' => ['type' => 'index', 'columns' => ['boss_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_students_bosses1' => ['type' => 'foreign', 'columns' => ['boss_id'], 'references' => ['bosses', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',

...
class CoursesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_courses_grade1_idx' => ['type' => 'index', 'columns' => ['grade_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_courses_grade1' => ['type' => 'foreign', 'columns' => ['grade_id'], 'references' => ['grades', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
